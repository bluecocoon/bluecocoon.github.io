...
GITHUB_REPONAME = "bluecocoon/bluecocoon.github.io"

#Public: Generate the blog files in _site directory
#
...
#Public: Generate and publish the the blog files in master branch
#
#Source: http://ixti.net/software/2013/01/28/using-jekyll-plugins-on-github-pages.html
